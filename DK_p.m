...
CorticalMeasuresENIGMA_CT=readmatrix('CorticalMeasuresENIGMA_ThickAvg.csv','Range',[39 2])
CorticalMeasuresENIGMA_SA=readmatrix('CorticalMeasuresENIGMA_SurfAvg.csv','Range',[39 2])
CorticalMeasuresENIGMA_MC=readmatrix('CorticalMeasuresENIGMA_MeanCurv.csv','Range',[39 2])
CorticalMeasuresENIGMA_GM=readmatrix('CorticalMeasuresENIGMA_GrayVol.csv','Range',[39 2])
CorticalMeasuresENIGMA_GC=readmatrix('CorticalMeasuresENIGMA_GausCurv.csv','Range',[39 2])
ICV=readmatrix('ICV.csv','Range',[39 2])
sex=readmatrix('sex.csv','Range',[39 2])
group=readmatrix('group.csv','Range',[39 2])
age=readmatrix('age.csv','Range',[39 2])
...
% z-score the inputs:
CorticalMeasuresENIGMA_CT_zscore=zscore(transpose(CorticalMeasuresENIGMA_CT));
CorticalMeasuresENIGMA_SA_zscore=zscore(transpose(CorticalMeasuresENIGMA_SA));
CorticalMeasuresENIGMA_GM_zscore=zscore(transpose(CorticalMeasuresENIGMA_GM));
CorticalMeasuresENIGMA_MC_zscore=zscore(transpose(CorticalMeasuresENIGMA_MC));
CorticalMeasuresENIGMA_GC_zscore=zscore(transpose(CorticalMeasuresENIGMA_GC));


% Create a cell for each subject with all of the required inputs:
clear subj_features5
for subj=1:nsubs
    subj_features5{1,subj}(:,1)=CorticalMeasuresENIGMA_CT_zscore(:,subj);
    subj_features5{1,subj}(:,2)=CorticalMeasuresENIGMA_SA_zscore(:,subj);
    subj_features5{1,subj}(:,3)=CorticalMeasuresENIGMA_GM_zscore(:,subj);
    subj_features5{1,subj}(:,4)=CorticalMeasuresENIGMA_MC_zscore(:,subj);
    subj_features5{1,subj}(:,5)=CorticalMeasuresENIGMA_GC_zscore(:,subj);
end
...
dlmwrite('results/CorticalMeasuresENIGMA_mytstat.dat',mytstat)
dlmwrite('results/CorticalMeasuresENIGMA_mypval.dat',mypval)
...
dlmwrite('results/CorticalMeasuresENIGMA_mytstat_lh.dat',mytstat)
dlmwrite('results/CorticalMeasuresENIGMA_mypval_lh.dat',mypval)