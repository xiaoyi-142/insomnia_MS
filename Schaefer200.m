...
importdata('schaefer100_SurfAvg.csv')
importdata('schaefer100_MeanCurv.csv')
importdata('schaefer100_GrayVol.csv')
importdata('schaefer100_GausCurv.csv')
importdata('sex.csv')
importdata('group.csv')
importdata('age.csv')
importdata('ICV.csv')

schaefer100_CT=readmatrix('schaefer100_ThickAvg.csv','Range',[39 2])
schaefer100_SA=readmatrix('schaefer100_SurfAvg.csv','Range',[39 2])
schaefer100_MC=readmatrix('schaefer100_MeanCurv.csv','Range',[39 2])
schaefer100_GM=readmatrix('schaefer100_GrayVol.csv','Range',[39 2])
schaefer100_GC=readmatrix('schaefer100_GausCurv.csv','Range',[39 2])
...
schaefer100_SA_zscore=zscore(transpose(schaefer100_SA));
schaefer100_GM_zscore=zscore(transpose(schaefer100_GM));
schaefer100_MC_zscore=zscore(transpose(schaefer100_MC));
schaefer100_GC_zscore=zscore(transpose(schaefer100_GC));


% Create a cell for each subject with all of the required inputs:
clear subj_features5
for subj=1:nsubs
    subj_features5{1,subj}(:,1)=schaefer100_CT_zscore(:,subj);
    subj_features5{1,subj}(:,2)=schaefer100_SA_zscore(:,subj);
    subj_features5{1,subj}(:,3)=schaefer100_GM_zscore(:,subj);
    subj_features5{1,subj}(:,4)=schaefer100_MC_zscore(:,subj);
    subj_features5{1,subj}(:,5)=schaefer100_GC_zscore(:,subj);
end
